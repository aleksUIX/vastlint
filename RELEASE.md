...
Chrome publish stays on `mnao305/chrome-extension-upload` v6.0.0. v7 requires `CHROME_PUBLISHER_ID` (Chrome Web Store Developer Dashboard, Publisher, Settings) and that secret is not configured yet.
