...
| `list_rules` | Returns all 195 rule IDs with severities and descriptions. Cache this - it's static. |
...
- [Rule reference](https://vastlint.org/docs/rules) - all 195 rules with examples and fix instructions
