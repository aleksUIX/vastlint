...
| `list_rules` | Returns all 191 rule IDs with severities and descriptions. Cache this - it's static. |
...
- [Rule reference](https://vastlint.org/docs/rules) - all 191 rules with examples and fix instructions
