...
| `list_rules` | Returns all 212 rule IDs with severities and descriptions. Cache this - it's static. |
...
- [Rule reference](https://vastlint.org/docs/rules) - all 212 rules with examples and fix instructions
