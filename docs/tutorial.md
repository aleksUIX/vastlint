...
Prints all 121 rules with their default severity and a short description. Rules marked `$` have direct revenue impact. Use the rule IDs in your `vastlint.toml` to customize behavior.
