...
pub static CATALOG: &[RuleMeta] = &[
    ...
    RuleMeta { id: "VAST-4.0-adverifications-unknown-child",    default_severity: Severity::Error,   description: "<AdVerifications> may only contain <Verification> elements",                            source: VastXsd  },
    RuleMeta { id: "VAST-4.0-verification-unknown-child",       default_severity: Severity::Error,   description: "<Verification> contains an unrecognised child element",                                 source: VastXsd  },
    RuleMeta { id: "VAST-4.0-viewableimpression-unknown-child", default_severity: Severity::Error,   description: "<ViewableImpression> contains an unrecognised child element",                           source: VastXsd  },
    RuleMeta { id: "VAST-4.0-wrapper-bool-attr",                default_severity: Severity::Warning, description: "<Wrapper> followAdditionalWrappers, allowMultipleAds and fallbackOnNoAd must be a boolean", source: VastXsd  },
    RuleMeta { id: "VAST-4.1-expires-integer",                  default_severity: Severity::Warning, description: "<Expires> value must be an integer number of seconds",                                  source: VastXsd  },
    ...
    RuleMeta { id: "SIMID-1.0-simid-url-https",               default_severity: Severity::Error,   description: "<InteractiveCreativeFile> SIMID URL must use HTTPS (not HTTP, javascript:, or file:)",   source: SimidSpec },
    RuleMeta { id: "SIMID-1.0-simid-url-data-html",           default_severity: Severity::Error,   description: "SIMID data: URI must declare text/html",                                                source: SimidSpec },
    RuleMeta { id: "SIMID-1.0-simid-apiframework-case",       default_severity: Severity::Warning, description: "apiFramework must be exactly \"SIMID\" (case-sensitive per SIMID §5)",                   source: SimidSpec },
    ...
    RuleMeta { id: "SIMID-1.0-simid-interactive-start",       default_severity: Severity::Info,    description: "Linear SIMID creative on VAST 4.2+ should include an interactiveStart tracking event",   source: SimidSpec },
    RuleMeta { id: "SIMID-1.0-simid-ssai-no-client",          default_severity: Severity::Info,    description: "Linear SIMID creative with a Mezzanine but no progressive MediaFile cannot run in SSAI", source: IndustryBestPractice },
    ...
    RuleMeta { id: "SIMID-1.1-iframe-simid-url-https",        default_severity: Severity::Error,   description: "<IFrameResource> SIMID URL must use HTTPS (not HTTP, javascript:, or file:)",            source: SimidSpec },
    // macros.rs
