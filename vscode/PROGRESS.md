...
- [x] `.vsix` packaged: **`vastlint-0.4.4.vsix`** - 13 files, 231 KB
...
### Release
- [ ] **Install locally** - `Cmd+Shift+P` → "Extensions: Install from VSIX..." → select `vastlint-0.4.4.vsix`
...
| `vscode/vastlint-0.4.4.vsix` | Packaged extension (ready to install/publish) |
