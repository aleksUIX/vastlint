...
| Milestone | Detail |
|---|---|
| **Core library** | `vastlint-core` v0.7 on crates.io - pure-Rust library, 191 rules, VAST 2.0–4.3 plus SIMID, OMID, VMAP 1.0, and DAAST 1.0 validation. |
...
| **REST API** | Authenticated `/validate` endpoint on [RapidAPI](https://rapidapi.com/aleksUIX/api/vastlint). Same 191 rules, WASM-powered, sub-millisecond response. |
